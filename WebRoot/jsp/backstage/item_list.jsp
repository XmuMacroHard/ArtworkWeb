                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption">所有商品</span>
                                ...
                                <div class="widget-body">
                                    <table class="table table-striped table-hover table-bordered" id="editabledatatable">
                                        ...
                                        <tbody>
                                        <s:iterator id="item" value="#request.itemList">
                                            <tr>
                                                <td><a href="ShowItemDetails?item.id=${item.id}"><s:property value="#item.name"/></a></td>
                                                <td><s:property value="#item.category"/></td>
                                                <td><s:property value="#item.type"/></td>
                                                <td id = "<s:property value="#item.id"/>">
                                                ...
                                                <td>
                                                    <s:a href="JavaScript:ItemRelieve(%{id});" cssClass="btn btn-success btn-xs"><i class="fa fa-edit"></i> 上架</s:a>
                                                    <s:a href="JavaScript:ItemBanning(%{id});" cssClass="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> 下架</s:a>
                                                </td>
                                            </tr>
                                        </s:iterator>
                                        </tbody>
