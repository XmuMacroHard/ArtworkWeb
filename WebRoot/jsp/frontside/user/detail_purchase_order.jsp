                    ...
                    <td class="a-right last" colspan="50">
					  ...
					  <c:choose>
					  	<c:when test="${purchaseOrder.state == '0'}">
					  		<button id="empty_cart_button" class="button btn-empty" onClick="{location.href='dispatch'}" title="Clear Cart" value="empty_cart" name="update_cart_action" type="submit"><span><span>付款</span></span></button>
					  	</c:when> 
						<c:when test="${purchaseOrder.state == '1'}"> 
					  	</c:when>
					  	<c:when test="${purchaseOrder.state == '2'}">
					  		<button id="empty_cart_button" class="button btn-empty" onClick="{location.href='dispatch'}" title="Clear Cart" value="empty_cart" name="update_cart_action" type="submit"><span><span>确认收货</span></span></button>
					  	</c:when> 		
