                                ...
                                <div class="widget-body">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editabledatatable">
                                        ...
                                        <s:iterator id="information" value="#request.list">
                                            <tr>
                                                <td>
                                                	<a href="getInfor.action?information.id=<s:property value="#information.id"/>"><s:property value="#information.title"/></a>
                                                </td>
                                                <td>
                                                    <s:date name="#information.startTime"/>
                                                </td>
                                                <td>
                                                    <s:date name="#information.endTime"/>
                                                </td>
                                                <td>
                                                    <s:property value="#information.location"/>
                                                </td>
                                                <td>
                                                    <s:property value="#information.expense"/>
                                                </td>
                                                <td>
                                                	<s:url id="show" action="show">
													<s:param name="username">
													<s:property value="user.username"/>
													</s:param>
													</s:url>
                                                    <s:a href="%{show}" cssClass="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> 通过</s:a>
                                                    <a href="#" class="btn btn-danger btn-xs delete"><i class="fa fa-trash-o"></i> 退回</a>
                                                </td>
                                            </tr>
                                        </s:iterator>
                                        </tbody>
